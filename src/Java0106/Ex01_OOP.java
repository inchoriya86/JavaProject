...
public class Ex01_OOP {
	...
	public static void main(String[] args) {
		/*
		 	...
		 	- 객체지향 단점 : 불필요한 메모리를 사용할 수 있음
		 	
		 	
		 	- 절차지향 : 순서대로 진행되는 프로그램
		 				ex) 급식소에서 줄서서 음식을 받는 것
			...
			- (2)객체(Object)  : 다른 것과 식별이 가능한 것
								자신만의 고유한 특성과 행동을 가지며
								다른 객체들과 상호작용을 한다.
								클래스 안에서 인스턴스(instance)라고도 부른다.
								ex) 토스트, 스마트폰
		  	...
		  	- (3)클래스 3요소
		  		...
		  		2) 메소드(method)
		  			...
		  			- 기능 수행이 끝나면 리턴값이 존재한다.
		  			  (리턴값은 메소드의 데이터타입과 일치해야 한다.)
		  			- 매개변수 : 몇개의 변수 사이에 함수관계를 정과를 정하기 위해
		  					    사용되는 또 다른 하나의 변수
